...
def main():
    st.set_page_config(page_title="Chat with the Streamlit docs, powered by LlamaIndex with Llama2", page_icon="🦙", layout="centered", initial_sidebar_state="auto", menu_items=None)

    st.title("Chat with AI Teaching assistant, powered by LlamaIndex & Llama2 💬🦙")
